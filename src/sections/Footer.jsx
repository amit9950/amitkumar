...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    {
      icon: <FaEnvelope />,
      url: "mailto:amitkumar@example.com",
      label: "Email",
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/5 transition-colors group">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-linear-to-br from-[#1cd8d2]/20 to-[#00bf8f]/20 group-hover:from-[#1cd8d2]/30 group-hover:to-[#00bf8f]/30 transition-all">
                  <FaMapMarkerAlt className="text-[#00bf8f]" />
                </div>
                <div>
                  <p className="text-sm text-gray-400">Location</p>
                  <p className="font-medium">Madhogarh Jalaun , India</p>
                </div>
              </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          >
            <p className="text-gray-400 text-sm">
              © {currentYear} <span className="text-[#00bf8f] font-medium">Amit Kumar</span>. All rights reserved.
            </p>
